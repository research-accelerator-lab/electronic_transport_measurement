...
from auto_vdp_sweepVg_procedure import AutoVdpProcedure_SweepVg
...
class MainWindow(ManagedDockWindow):
    ...
    def __init__(self):
        ...
        boxes = ['atlas_addr', 'study_id', 'wafer_id','map_1_chip_id','map_2_chip_id', 'map_3_chip_id',
                 'gate_voltage_start', 'gate_voltage_end', 'gate_voltage_step','gate_voltage_sweep_rate','vdp_cur',
                 'setting_nplc','setting_filter']
        
        super(MainWindow, self).__init__(
            procedure_class=AutoVdpProcedure_SweepVg,
            inputs=boxes,
            displays=boxes,
